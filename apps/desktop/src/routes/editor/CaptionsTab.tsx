						...
						<Field name="Font Settings" icon={<IconCapMessageBubble />}>
							<div class="space-y-3">
								...
								<div class="flex flex-col gap-2">
									...
									<p class="text-xs text-gray-10">
										This is the first version of captions in Zensloom. Active
										word highlighting may be inaccurate in some situations.
										We're working on a fix for this and it will be released in
										upcoming versions.
									</p>
								</div>
